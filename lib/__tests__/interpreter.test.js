...
describe('interpreter', function () {
  it('handles errors correctly', function () {
    expect(function () {
      return (0, _interpreter["default"])('error "x"')();
    }).toThrow('x');
  });
  tests.forEach(function (_ref) {
    var sourceCode = _ref.sourceCode,
      output = _ref.output,
      input = _ref.input;
    it("executes ".concat(sourceCode), function () {
      expect((0, _interpreter["default"])(sourceCode)(input)).toEqual(output);
    });
    it("correct target code ".concat(sourceCode), function () {
      expect((0, _compiler["default"])(sourceCode)).toMatchSnapshot();
    });
    it("correct target tree ".concat(sourceCode), function () {
      expect((0, _parser["default"])(sourceCode)).toMatchSnapshot();
    });
  });
  it('allow passing single variable', function () {
    expect((0, _interpreter["default"])('$foo')(null, {
      foo: 3
    })).toEqual(3);
  });
  it('allow passing multiple variables', function () {
    expect((0, _interpreter["default"])('$foo + $bar')(null, {
      foo: 4,
      bar: -2
    })).toEqual(2);
  });
  it('doesn\'t allow passing functions', function () {
    expect(function () {
      return (0, _interpreter["default"])('foo 4')(null, {
        foo: function foo(x) {
          return 3;
        }
      });
  ...
  it('throws syntax error on invalid source code', function () {
    expect(function () {
      (0, _interpreter["default"])('¡');
    }).toThrow(SyntaxError);
  });
});